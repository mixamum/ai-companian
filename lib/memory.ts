...
//         // await pineconeClient.describeIndex(process.env.PINECONE_INDEX!);

//         // const list = await pineconeClient.listIndexes();

//         // console.log(list)
//         await pineconeClient.listIndexes();
//         let value = await pineconeClient.describeIndex(process.env.PINECONE_INDEX!);
//         return value


//         // const pineconeIndex = pineconeClient.describeIndex(
